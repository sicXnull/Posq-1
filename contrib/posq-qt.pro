...
RESOURCES += src/qt/posq.qrc src/qt/posq_locale.qrc

TRANSLATIONS += src/qt/locale/posq_bg.ts \
                src/qt/locale/posq_de.ts \
                src/qt/locale/posq_en.ts \
                src/qt/locale/posq_es.ts \
                src/qt/locale/posq_fi.ts \
                src/qt/locale/posq_fr.ts \
                src/qt/locale/posq_it.ts \
                src/qt/locale/posq_ja.ts \
                src/qt/locale/posq_pl.ts \
                src/qt/locale/posq_pt.ts \
                src/qt/locale/posq_ru.ts \
                src/qt/locale/posq_sk.ts \
                src/qt/locale/posq_sv.ts \
                src/qt/locale/posq_vi.ts \
                src/qt/locale/posq_zh_CN.ts \
                src/qt/locale/posq_zh_TW.ts
