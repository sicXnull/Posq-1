...
extern std::string HelpRequiringPassposqase();
...
extern UniValue walletpassposqase(const UniValue& params, bool fHelp);
extern UniValue walletpassposqasechange(const UniValue& params, bool fHelp);
...
extern UniValue setzposqseed(const UniValue& params, bool fHelp);
extern UniValue getzposqseed(const UniValue& params, bool fHelp);
