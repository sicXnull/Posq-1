...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    changePassposqaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passposqase..."), this);
    changePassposqaseAction->setStatusTip(tr("Change the passposqase used for wallet encryption"));
    ...
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passposqase"));
    ...
    if (walletFrame) {
        ...
        connect(changePassposqaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassposqase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassposqaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassposqaseAction->setEnabled(enabled);
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassposqaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassposqaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
