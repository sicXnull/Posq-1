                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    bool showWatchOnlyPOSQAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showPOSQPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyPOSQPending = watchUnconfBalance != 0;
    bool showPOSQLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyPOSQLocked = nWatchOnlyLockedBalance != 0;
    ...
    ui->labelWatchAvailable->setVisible(showPOSQAvailable && showWatchOnly);
    ...
    ui->labelWatchPending->setVisible(showPOSQPending && showWatchOnly);
    ...
    ui->labelWatchLocked->setVisible(showPOSQLocked && showWatchOnly);
