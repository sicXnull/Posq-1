 ...
 */
    ...
    typeWidget->addItem(tr("Received POSQ from zPOSQ"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zPOSQ"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zPOSQ));
