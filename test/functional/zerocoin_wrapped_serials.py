#!/usr/bin/env python3
# Copyright (c) 2019 The POSQ Core developers
...
from fake_stake.base_test import POSQ_FakeStakeTest

class zPOSQwrappedSerialsTest(POSQ_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPOSQs..." % DENOM_TO_USE)
