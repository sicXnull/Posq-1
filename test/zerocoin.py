...
#   c) node1 mines 32 blocks, so now node 0 has 60001posq, node 1 has 4250posq, node2 has none.
#   d) node0 sends 601 posq to node2, in two transactions (301 posq, then 300 posq).
